...
class _JoinScreenState extends State<JoinScreen> {
  ...
  void initState() {
    ...
    // SignallingService.instance.sockeTest!.on("newCall", (data) {
    //   if (mounted) {
    ...
    // SignallingService.instance.socket?.stream.asBroadcastStream().listen((event) {
    //   final data = jsonDecode(event);
    //   if (mounted && data['type'] == 'new_meeting') {
    //     setState(() => incomingSDPOffer = data);
    //   }
    // });
